...
* Companion object is automatically created for our class. It contains autogenerated `apply` method which allows us to create instance of our class without the `new` keyword:
...
* The class also has automatically generated `copy` method which allows us to make copies of instances of our class with some of the fields changed:
...
* We can *pattern-match* against our class. We will soon explain in detail what that means. For the sake of completeness, we'll mention that this is allowed thanks to the automatically generated magic `unapply` method in the companion object. Don't worry about what that means now, though.
